...
import _ajvLatestDistCompileEqual from "ajv-current/dist/compile/equal";
import _ajvLatestDistCompileUcs2length from "ajv-current/dist/compile/ucs2length";
var module = {
  exports: {}
};
...
const func8 = _ajvLatestDistCompileUcs2length.default;
const func0 = _ajvLatestDistCompileEqual;
                  ...
                  if (data4.age === undefined && (missing1 = "age") || data4.height === undefined && (missing1 = "height")) {
                    ...
                    if (data4.age !== undefined) {
                      ...
                      if (!(typeof data5 == "number" && !(data5 % 1) && !isNaN(data5) && isFinite(data5))) {
                        validate20.errors = [{
                          keyword: "type",
                          dataPath: dataPath + "/personalData/age",
                          schemaPath: "#/properties/personalData/properties/age/type",
                          params: {
                            type: "integer"
                          },
                    ...
                    if (typeof data9 === "string") {
                      if (func8(data9) > 5) {
                        validate20.errors = [{
                          ...
                          message: "should NOT have more than 5 characters"
                        }];
                        return false;
                      }
                    } else {
